"""
Video service for the YouTube Summarizer backend.
...
from app.utils.cache import get_cached_video_info, cache_video_info, get_cached_transcript, cache_transcript, cache_available_languages
...
async def extract_video_info(url: str) -> Dict[str, Any]:
    ...
    cached_video_info = await get_cached_video_info(video_id)
    ...
    if cached_transcript:
        ...
        try:
            ...
            with yt_dlp.YoutubeDL(minimal_opts) as ydl:
                ...
                await cache_video_info(video_id, video_info)
                return video_info
    ...
    try:
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            if transcript_text:
                ...
                await cache_transcript(video_id, {
            ...
            if video_info.get('transcript'):
                ...
                if info.get('subtitles') or info.get('automatic_captions'):
                    ...
                    await cache_available_languages(video_id, languages)
